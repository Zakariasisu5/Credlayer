...
const nav: NavItem[] = [
  ...
  { href: "/app/profile", label: "Reputation", icon: UserRound },
  { href: "/app/explorer", label: "Explorer", icon: Search },
  { href: "/app/agents", label: "AI Agents", icon: Bot },
  { href: "/app/credentials", label: "Credentials", icon: BadgeCheck },
          ...
          <>
            ...
            >
              <div className="glass-strong flex-1 rounded-2xl p-4 flex flex-col h-full">
                <Link href="/" className="px-2 pb-4" onClick={() => setMobileOpen(false)}>
                  <Logo className="h-8" />
                </Link>
                <SidebarLinks
                  pathname={pathname}
