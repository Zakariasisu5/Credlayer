    ...
    <>
      ...
      <main className="relative overflow-hidden bg-background min-h-screen pt-20">
        ...
        <div className="space-y-6">
                ...
                return (
                  <div key={info.title} className="flex items-start gap-4">
                    <div className="flex-shrink-0">
                      <div className="inline-flex items-center justify-center w-10 h-10 bg-primary/10 rounded-lg border border-primary/30">
          ...
          <div className="rounded-xl border border-border bg-card/80 backdrop-blur-sm p-6 shadow-card">
            <h3 className="text-xl font-bold mb-3 text-foreground">Quick Response</h3>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">Technical Support: 2-4 hours</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 bg-yellow-400 rounded-full" />
                <span className="text-muted-foreground">Sales Inquiry: 4-8 hours</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 bg-primary rounded-full" />
                <span className="text-muted-foreground">General: 12-24 hours</span>
              </div>
            </div>
          </div>

          <div className="rounded-xl border border-border bg-card/80 backdrop-blur-sm p-6 shadow-card">
            <h3 className="text-xl font-bold mb-3 text-foreground">Follow Us</h3>
            <p className="text-sm text-muted-foreground mb-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="inline-flex items-center justify-center w-10 h-10 bg-primary/10 hover:bg-primary/20 rounded-lg border border-primary/30 transition-colors"
              >
